...
#    data_collector_Sens10.start()
    ...
    MaxHumidityBeforeStart = 95 #68+4+6+3+3+2+4 #Humidty to exceed efore engine starts 181111 ELT: 63->66 181208 ELT: 66->68 ELT190105 +4 added to compensate for sensor offset 190426 ELT: +7 added
    MinHumidityBeforeStop = 92 #64+4+6+3+3+3+4 #Humdity before engine stops 181111 ELT: 57->60 181128 ELT: Stop changed to 61 181208: 61->64 ELT 190105 +4 added to compensate for sensor offset 190426 ELT: +7 added
    EngineStatus = "OFF"
    OldEngineStatus = "OFF"
    EngineOn = 0
    EngineOnCounter = 0
